...
const AuthLayout = ({ children }) => {
    return <div className = "flex">
        ...
        <div className = "hidden md:block w-[40vw] h-screen bg-blue-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
            ...
            <div className="w-48 h-56 rounded-[40px] border-[20px] border-fuchsia-600 absolute top-[30%] -right-100"/>
            ...
            <img
                ...
                //src={CARD_2}
                //className="w-64 lg:w-[90%] absolute bottom-10 shadow-lg shawdow-blue-400/15"
